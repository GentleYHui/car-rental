...
<script type="text/javascript">
    ...
    layui.use(['jquery', 'layer', 'form', 'table'], function () {
        ...
        tableIns = table.render({
            ...
            , {field: 'identity', title: '身份证号', align:
                    'center', width: '200'}
            , {field: 'custname', title: '客户姓名', align:
                    'center', width: '125'}
            , {field: 'address', title: '客户地址', align:
                    'center', width: '125'}
            , {field: 'career', title: '客户职业', align:
                    'center', width: '150'}
            , {field: 'phone', title: '⼿机号码', align:
                    'center', width: '150'}
            , {
                field: 'sex', title: '性别', align: 'center',
                width: '120', templet: function (d) {
            ...
            , {fixed: 'right', title: '操作', toolbar:
                    '#customerBar', align: 'center', width: '150'}
        ]],
        ...
        $("#doSearch").click(function () {
            ...
            tableIns.reload({
                url:
                    "${pageContext.request.contextPath}/customer/loadAllCustomer.action?" + params,
                page: {curr: 1}
        })
        });
        ...
        table.on('tool(customerTable)', function (obj) {
            ...
            if (layEvent === 'del') { //删除
                layer.confirm('真的删除【' + data.custname + '】这个客户么？',
                    function (index) {
                        //向服务端发送删除指令
        ...
        function openUpdateCustomer(data) {
            mainIndex = layer.open({
                ...
                success: function (index) {
                    ...
                    url =
                        "${pageContext.request.contextPath}/customer/updateCustomer.action";
                }
            });
        }
